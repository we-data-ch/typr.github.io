...
> The full development workflow of a TypR package: building, testing, and documenting it.
...
logic and tests side by side — the transpiler extracts them into
...
The package installs and checks like any standard R package. CRAN, R CMD check,
and pkgdown all see regular R code — TypR is invisible at this stage.
...
| Missing type errors | Run `typr build` — the compiler reports type errors before generating R code |
